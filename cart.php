...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="flex">
            <div class="price"><span></span><?php $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); echo "Rp " . number_format($sub_total, 0, ',', '.'); ?></div>
            <input type="number" name="qty" class="qty" min="1" max="99" value="<?= $fetch_cart['quantity']; ?>" maxlength="2">
            <button type="submit" class="fas fa-edit" name="update_qty"></button>
         </div>
         <div class="sub-total"> Sub Total : <span><?php
            $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); echo "Rp " . number_format($sub_total, 0, ',', '.');?></span> </div>
      </form>
      <?php
